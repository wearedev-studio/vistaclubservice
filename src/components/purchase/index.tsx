...
const Purchase = () => {
    return (
        <>
            <div className="cards-06 page_section_45 section section_container-width_1200" id="">
                ...
                >
                    ...
                    />
                    <CarInfo
                        imgPath='./images/007/499/164/7499164/610x458crop/GenesisGV80.jpg'
                        name='Genesis GV80'
                        price='4 556 000'
                        year='2021'
                        driveUnit='4WD'
                ...
                <div className="animated-section button-02 page_section_48 section section_container-width_1200" id="">
