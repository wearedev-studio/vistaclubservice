const CustomsBroker = () => {
    return (
          <div className="page_section_22 promo-05 section section_container-width_1200" id="">
                ...
                <div className="promo-05-content">
                    <div className="promo-05-content__title wysiwyg-string">
                        <div>
                            ...
                            с опытом работы 15 лет<br />
                            в штате GET AUTO!
                        </div>
                    </div>
                    <div className="promo-05-content__text wysiwyg-string">
                        <strong>Мы гарантируем нашим клиентам:</strong><br />
                        <strong>1.</strong> Прохождение таможни без препятствий;<br />
                        <strong>2. </strong>Работу без посредников и скрытых платежей;<br />
                        <strong>3. </strong>Соответствие автомобиля заявленному состоянию.<br />
                        <br />
                    </div>
                    <div className="promo-05-content__btns-container">
                        ...
                        ><div className="button__inner"><span className="button__text">Задать вопрос менеджеру</span></div></a>
                    </div>
                </div>
            </div>
        </div>
